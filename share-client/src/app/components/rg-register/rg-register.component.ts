...
export class RgRegisterComponent {
  ...
  constructor(private fb: FormBuilder, private router: Router, private rgService: RgService, private authService: AuthService) {
  ...
  onSubmit() {
    ...
    if (!this.isSubmitting) {
      ...
      this.rgService.registerUser(payload).subscribe({
        next: res => {
